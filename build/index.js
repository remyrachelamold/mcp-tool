...
app.post("/mcp", async (req, res) => {
    ...
    if (sessionId && transports[sessionId]) {
        ...
        // Get all items
        server.tool("get-all-items", "Get all items", {}, async ({}) => {
            try {
        ...
        // Create item
        server.tool("create-item", "Create an item", {
        ...
        // Delete item
        server.tool("delete-item", "Delete an item", {
            id: z.string().describe("ID of the item"),
        }, async ({ id }) => {
            try {
